...
const IntegrationsPage: React.FC = () => {
  ...
  const [selectedIntegrationDetail, setSelectedIntegrationDetail] =
            ...
            integrations.map((integration) => (
              <Card
                ...
                extra={
                  <Space>
                    ...
                    <Button icon={<SettingOutlined />} onClick={() => handleConfigure(integration)}>
                      Configure
                    </Button>
                  </Space>
                }
              >
                ...
                {selectedIntegrationDetail &&
                  selectedIntegrationDetail.syncHistory &&
                  selectedIntegrationDetail.syncHistory.length > 0 && (
                    <div style={{ marginTop: 16 }}>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSaveConfig}>
          <Form.Item
            ...
            help={
              selectedIntegrationDetail?.hasApiKey
                ? 'API key is already configured. Leave blank to keep existing.'
                : ''
            }
          >
          ...
          <Form.Item
            ...
            help={
              selectedIntegrationDetail?.hasApiSecret
                ? 'API secret is already configured. Leave blank to keep existing.'
                : ''
            }
          >
